"""
Django settings for hubtel_project project.
...
ROOT_URLCONF = "hubtel_project.urls"
...
WSGI_APPLICATION = "hubtel_project.wsgi.application"
...
HUBTEL_CONFIG = {
    'CLIENT_ID': config('HUBTEL_CLIENT_ID'),
    'CLIENT_SECRET': config('HUBTEL_CLIENT_SECRET'),
